...
namespace SimpleShapeGrammar.Classes
{
    ...
    public static class MOO_Utility
    {
        public static List<SH_Rule> NewGenome(List<object> rules, List<double> weights, Random random)
        {
            ...
            while (state != State.end ) // can remove this max 20 when i've controlled that it works. Start by increasing to 100, then 1000, then remove.
            {
                object listElement;
                ...
                if (ruleString != null)
                {
                    ...
                    if (ruleObject != null)
                    {
                        ...
                        if (ruleObject.RuleState == state)
                        {
                            ...
                            // create the parameters of the rule
                            ruleObject.NewRuleParameters(random, numLines);
        ...
        public static object TestActivator()
        {
            ...
            instantiateObject.NewRuleParameters(rnd, 0); // Set the translation vectors for this
